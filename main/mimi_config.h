...
/** Relative to data dir: JSON Lines trace of prompts, LLM replies, tool I/O */
#define MIMI_AGENT_TRACE_REL         "logs/agent_trace.jsonl"
#define MIMI_AGENT_TRACE_MAX_FIELD   (256 * 1024)
...
#define MIMI_LLM_MAX_TOKENS          (32 * 1024)
...
/** When 1, Moonshot OpenAI-compatible chat requests may include Kimi builtin_function $web_search */
#ifndef MIMI_KIMI_BUILTIN_WEB_SEARCH
#define MIMI_KIMI_BUILTIN_WEB_SEARCH 0
#endif
